...
app.put("/users/clear-build-cart/:userID", userController.putClearCarts)


//Builds
app.get("/builds", buildController.getAll);
app.get("/builds/:id", buildController.getByID);
app.post("/builds/add-build", buildController.postNewBuild)
app.put("/builds/add-user-like/:buildID/:userID", buildController.putAddUserLike)
app.put("/builds/remove-user-like/:buildID/:userID", buildController.putRemoveUserLike)
...
app.post("/bikes/add-bike", bikeController.postPart)
